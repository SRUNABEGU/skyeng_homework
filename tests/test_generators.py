...
def test_filter_by_usd(sample_transactions):
...
def test_filter_by_rub(sample_transactions):
...
def test_unexpected_filter(transactions, currency, expected):
...
def test_unexpected_descriptions(empty_list):
...
@pytest.mark.parametrize('start, stop, expected', [
    ...
    (0, 3, ['0000 0000 0000 0000', '0000 0000 0000 0001', '0000 0000 0000 0002', '0000 0000 0000 0003']),
    (0, 0, ['0000 0000 0000 0000']),
    (0, 0, ['0000 0000 0000 0000']),
])
def test_unexpected_card_number_generator(start, stop, expected):
